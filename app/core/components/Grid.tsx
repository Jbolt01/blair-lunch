...
const GridComponentWithQuery = ({ toggle, orderBy }) => {
  ...
  if (
    query.category &&
    ["athletics", "clubs", "academic", "misc"].includes(query.category as string)
  ) {
  ...
  const [listingPages, { isFetchingNextPage, fetchNextPage, hasNextPage, refetch }] =
